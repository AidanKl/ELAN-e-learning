...
- subtitel: Reproduceerbaar werken
  blokken:
  - type: tekst
    inhoud: '- **Versiebeheer:** Git of datumstempels in bestandsnamen.
  ...
  - type: code
    taal: text
    inhoud: '1_data_inladen      -> inladen + validatiechecks, schone basisset opslaan
...
- subtitel: Veelgemaakte analysefouten
  ...
  - type: valkuil
    ...
    inhoud: '- ICPC-codes als diagnose zonder validatiestrategie.
...
- subtitel: Veelgebruikte samengestelde variabelen
  blokken:
  - type: tabel
    inhoud: '| Variabele | Aandachtspunt |
